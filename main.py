...
print(f"{name} liked to hum the song {song} while coding. It was so annoying that their teammates would throw {food} unitl {name} would stop singing ")
...
# 1st_name
first_name_1 = "Ernesto"
# last name
last_name_1 = "Cortez-Garcia"
# email@address
email_address_1 = "ecortez-gar@cps.edu"
# percent%
percent = "25%"
# variable#name
...
print(int_num)
print(type(int_num))
# type() identifies the type of data typed
name = "Tony"
print(type(name))
ClassInSession = True
...
total_cost = print("You have $" + str(total_cost) + " for the money and dinner")

# Declare a numeric variable named decimal_num that contains a value of float type of your choice.
decimal_num = 7.5
#python allows for implicit and explicit conversion
#implicit means it is inferred already by the program
#explicit means that it is explictly defined
